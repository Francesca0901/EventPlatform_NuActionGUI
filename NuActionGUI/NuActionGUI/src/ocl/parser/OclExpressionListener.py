...
class OclExpressionListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by OclExpressionParser#FoldExp.
    def enterFoldExp(self, ctx:OclExpressionParser.FoldExpContext):
        pass

    # Exit a parse tree produced by OclExpressionParser#FoldExp.
    def exitFoldExp(self, ctx:OclExpressionParser.FoldExpContext):
        pass
